...
import com.collabera.springboot.model.Role;
import com.collabera.springboot.model.User;
import com.collabera.springboot.repository.UserRepository;
...
public class UserServiceImpl implements UserService{
	...
	public User save(UserRegistrationDto registrationDto) {
		User user = new User(registrationDto.getUserId(),
	...
	@Override
	public List<User> getAllRestData() {
